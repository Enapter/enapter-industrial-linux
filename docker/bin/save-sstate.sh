...
if [[ -z "${SKIP_SSTATE_SAVE}" ]]; then
  /home/build/enapter-linux-build/openembedded-core/scripts/sstate-cache-management.py --stamps-dir=/home/build/tmp-glibc/stamps -y --cache-dir=/home/build/sstate-cache
